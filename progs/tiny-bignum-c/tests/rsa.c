...
static void test_rsa1024(void)
{
  ...
  for (int i =1; i<size-1; i++) {
    size_t mid = cc+dist*i;
    size_t base = mid;
    struct bn* e = (struct bn*)base; /* public exponent */
